...
// ============================================================
const GAME = { scene: 'boot', t: 0, p: null, lv: null, levelIdx: 0, photo: null, photoReady: false, shop: null, pause: false, pauseCooldown: 0, sel: 0, after: null, endT: 0, rank: '' };
...
function setScene(s) { GAME.scene = s; GAME.t = 0; GAME.pause = false; GAME.pauseCooldown = 0; Input.tap = null; }
...
function step() {
  ...
  switch (GAME.scene) {
    case 'boot': GAME.t++; if (GAME.t > 2) { GAME.introPhase = 0; setScene('intro'); } break;
    case 'play': updatePlay(); if (!GAME.pause) GAME.t++; break;
    default: GAME.t++; break;
  }
}
function render() {
